...
public class SwipeDeck extends FrameLayout {
    ...
    private int middleImageResource;
    ...
    private void addNextView() {
        if (adapterIndex < mAdapter.getCount()) {
            ...
            if (middleImageResource != 0) {
                card.setMiddleImageResource(middleImageResource);
            }
            card.setId(viewId);
    ...
    public void setMiddleImage(int imageResource) {
        middleImageResource = imageResource;
    }
